...
static void setup_screen(void *user_data) {
    ...
    lv_obj_set_style_pad_all(screen_list, 6, LV_PART_MAIN);
    lv_obj_set_size(screen_list, LV_PCT(96), LV_PCT(98));
    lv_obj_set_pos(screen_list, LV_PCT(2), LV_PCT(1));
    lv_obj_set_style_radius(screen_list, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_width(screen_list, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
