...
cv::Mat resizeMatForScreen(const cv::Mat &mat, cv::Size scr);
void getImgArray(const cv::Mat &img,lv_img_header_t &Output,uint8_t * &data,ENCODE_MODE encode_mode=ENCODE_DITHER);
cv::Mat getDitherMat(const cv::Mat &img_read);
